			...
			<div class="box10">
				<div id="stage">
					...
					if($sessiondata->status=='c')
					{
						...
						<li><a href="<?php echo SITE_URL;?>/development_agency/registration_step2" class="active"><span>2</span>section</a></li>
				...
				<ul>
					...
					<input type="submit" name="developersavesteptwo" value="NEXT" class="submit"></li>
				</ul>
			</div>
			</form>
		</div>
