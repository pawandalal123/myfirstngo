 ...
 <form action="" method="post">
			<div class="box10">
				...
				<ul>
					<li class="half">
						<label>Name</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_name_of_person ? @$sessiondata->govt_name_of_person : set_value('name');?>"  name="name"/>
						<?php echo form_error('name')?>
					</li>
					<li class="half rgt">
						<label>Designation</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_designation ? @$sessiondata->govt_designation : set_value('designation');?>"  name="designation"/>
						<?php echo form_error('designation')?>
					</li>
					<li class="half cl">
						<label>Email</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_email ? @$sessiondata->govt_email : set_value('email');?>"  name="email"/>
						<?php echo form_error('email')?>
					</li>
					<li  class="half rgt">
						<label>Phone</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_phone ? @$sessiondata->govt_phone : set_value('phone');?>"  name="phone"/>
