			...
			<div class="box10">
				<div id="stage">
					...
					if($sessiondata->status=='c')
					{
						...
						<li><a href="<?php echo SITE_URL;?>/development_agency/registration_step3" class="active"><span>3</span>section</a></li>
				...
				<ul>
					...
					<li class="half rgt">
						...
						<input type="text" value="<?php echo  @$sessiondata->dev_no_of_proj ? @$sessiondata->dev_no_of_proj : set_value('dev_no_of_proj');?>"   name="dev_no_of_proj"/>
						<?php echo form_error('dev_no_of_proj')?>
					</li>
					<li class="half cl">
						<label>Geographical Area Preference</label>
						<input type="text" value="<?php echo  @$sessiondata->dev_geo_area ? @$sessiondata->dev_geo_area : set_value('geo_area');?>"   name="geo_area"/>
					</li>
					<li  class="half rgt">
						<label>&nbsp;</label>
					...
					<li  class="half">
						...
						<input type="text" value="<?php echo  @$sessiondata->dev_min_amount ? @$sessiondata->dev_min_amount : set_value('dev_min_amount');?>"  name="dev_min_amount"/>
					</li>
					<li  class="half rgt">
						<label>Max amount for project</label>
						<input type="text" value="<?php echo  @$sessiondata->dev_max_amount ? @$sessiondata->dev_max_amount : set_value('dev_max_amount');?>"  name="dev_max_amount"/>
					</li>
					<li>
						<label>Target no of NGOs to be engaged </label>
						<input type="text" value="<?php echo  @$sessiondata->dev_no_of_ngo ? @$sessiondata->dev_no_of_ngo : set_value('dev_no_of_ngo');?>"  name="dev_no_of_ngo"/>
					</li>
					<li>
					<!-- <a href="form_development_agency_stage4.html" class="submit">NEXT</a> -->
					<input type="submit" name="developersavestepthree" value="NEXT" class="submit"></li>
				</ul>
			</div>
			</form>
		</div>
