 ...
 <?php $this->session->unset_userdata('msg');}?>
			...
			<div class="box10">
				<div id="stage">
					...
					{
						?>
						<li><a href="<?php echo SITE_URL;?>/Government_agency/registration_step1" class="active"><span>1</span>Company Detail</a></li>
				...
				<ul>
					<li>
						<label>Name of the Department/ Ministry/ Institution*</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_dept_name ? @$sessiondata->govt_dept_name : set_value('department');?>"  name="department"/>
						<?php echo form_error('department');?>
					</li>
					<li class="half">
						<label>Address*</label>
						<textarea type="text"   name="address"><?php echo  @$sessiondata->govt_address ? @$sessiondata->govt_address : set_value('address');?></textarea>
						<?php echo form_error('address');?>
					</li>
					<li  class="half rgt">
						<label>State*</label>
						<input type="text" value="<?php echo  @$sessiondata->gov_state ? @$sessiondata->gov_state : set_value('state');?>" name="state" />
						<?php echo form_error('state');?>
					</li>
					<li  class="half rgt">
						<label>City*</label>
						<input type="text" value="<?php echo  @$sessiondata->gov_city ? @$sessiondata->gov_city : set_value('city');?>" name="city" />
						<?php echo form_error('city');?>
					</li>
					<li  class="half cl">
						<label>Website*</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_website ? @$sessiondata->govt_website : set_value('website');?>" name="website"/>
						<?php echo form_error('website');?>
					</li>
					<li  class="half rgt">
						<label>Sector</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_sector ? @$sessiondata->govt_sector : set_value('sector');?>" name="sector"/>
					</li>
					<li>
						<label>Region</label>
						<input type="text" value="<?php echo  @$sessiondata->govt_region ? @$sessiondata->govt_region : set_value('region');?>" name="region"/>
					</li>
					<li><input type="submit" name="savefirst" value="NEXT" class="submit"></li>
				</ul>
			</div>
			</form>
		</div>
